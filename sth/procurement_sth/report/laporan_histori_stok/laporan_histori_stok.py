	...
	def get_columns(self):
		...
		columns.extend(
				...
				# },
    		{
				...
				{
					"label": _("Saldo Awal Harga Satuan"),
					"fieldname": "val_rate",
				...
				{
					"label": _("Saldo Awal Total Rupiah"),
				...
				{"label": _("Masuk Total Rupiah"), "fieldname": "in_val", "fieldtype": "Float", "width": 80},
				{
					"label": _("Keluar Kuantitas"),
					"fieldname": "out_qty",
					"fieldtype": "Float",
					"width": 80,
					"convertible": "qty",
				...
				{"label": _("Keluar Total Rupiah"), "fieldname": "out_val", "fieldtype": "Float", "width": 80},
				# {
				...
				{
					"label": _("Saldo Akhir Harga Satuan"),
					"fieldname": "val_rate",
					"fieldtype": self.filters.valuation_field_type or "Currency",
					"width": 90,
					"convertible": "rate",
				...
				{
					"label": _("Saldo Akhir Total Rupiah"),
					"fieldname": "bal_val",
					"fieldtype": "Currency",
					"width": 100,
					"options": "Company:company:default_currency",
