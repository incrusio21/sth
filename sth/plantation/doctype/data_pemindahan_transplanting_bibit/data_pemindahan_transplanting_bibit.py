...
class DataPemindahanTransplantingBibit(Document):
	def get_available_qty(self):
		...
		if data:
			self.available_qty = (data.get("qty") or 0) - (data.get("transplanting_qty") or 0)
		else:
	...
	def recalculate_qty_data_penyemaian_bibit(self):
		dpda = frappe.qb.DocType("Data Pemindahan Transplanting Bibit")
		...
		doc.transplanting_qty = used_total
