...
class FileUploader {
    constructor({
        ...
        attach_doc_image,
        frm,
        make_attachments_public,  // Modified: default to true
        allow_web_link,
        allow_take_photo,
        ...
        // ADD THIS: Set default to public if not explicitly set
        ...
        let app = createApp(FileUploaderComponent, {
            ...
            disable_file_browser,
            attach_doc_image,
            make_attachments_public,  // This will now default to true
            allow_web_link,
            allow_take_photo,
            allow_toggle_private,
            allow_toggle_optimize,
        ...
        watch(
            ...
            (files) => {
                ...
                if (this.dialog) {
                    // MODIFIED: Swap the labels since default is now public
    ...
    make_dialog(title) {
        this.dialog = new frappe.ui.Dialog({
            ...
            secondary_action_label: __("Set all private"),  // Initial label
            secondary_action: () => {
