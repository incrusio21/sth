...
class SthStockController(StockController):
			...
			if sle_list:
				for sle in sle_list:
					if warehouse_account.get(sle.warehouse):
						...
						wh_account = warehouse_account[sle.warehouse]["account"]
						if item_row.get("item_code") and item_doc.get("kelompok_barang"):
							item_doc = frappe.get_doc("Item",item_row.get("item_code"))
